...
<body>
	<div>
     	...
     	<p id="navbar">当前位置：学生选课>>专业${state}课</p>
     </div>
     <table class="table">
     	<tr >
     		<th>课程编号</th>
     	...
     	<c:forEach items="${list}" var="course">
     		<tr>
     			<td>${course.cid }</td>
     			<td>${course.cname}</td>
     			<td><a href="show_course/classMsg.do?cname=${course.cname }&college=${sessionScope.STUDENT_SESSION_KEY.profession}&profession=${sessionScope.STUDENT_SESSION_KEY.profession}&learn=${course.learn}&year=${sessionScope.STUDENT_SESSION_KEY.year}">选取</a></td>
     		</tr>
     	</c:forEach>
     </table>
     ...
     <table class="table table1">
     	...
     	<c:forEach items="${list1}" var="course1">
     		<tr>
     			...
     			<td><a href="select_course/selectCourses.do?classid=${course1.classid }&sid=${sessionScope.STUDENT_SESSION_KEY.sid}&time=${course1.time }&courseURL=show_course/classMsg.do">选取</a></td>
     		</tr>
     	</c:forEach>
     </table>
</body>
